	...
	<div class="container">
		...
		<td colspan="5"><a href="../review/write.jsp"> <input type="button"
				...
				<td colspan="5">
					...
					<nav aria-label="Page navigation example">
						<ul>
							...
							<li><a href="../review/list3.jsp?cp=<%=i%>"><%=i%></a></li>
							<%}if (isNext) {%>
			...
			<tr>
				...
				<input type="text" name="search" id="search" placeholder="검색어" value="" onkeypress="filter()"/>
				<input type="submit" value="검색" onclick="filter()"/>
	...
	<script>
       function filter() {
        ...
        for (let i = 0; i < listInner.length; i++) {
          facname = listInner[i].getElementsByClassName("facname");
          if (facname[0].innerHTML.toLowerCase().indexOf(search) != -1) {
